...
class Sale extends Model
{
    ...
    {
        return $this->items->sum(fn ($i) => $i->hpp * $i->quantity);
    }

    public function complete(): void
    {
        $this->update(['status' => 'completed', 'payment_status' => 'paid', 'completed_at' => now()]);
    }
    ...
    public function scopeByPaymentMethod($q, $m)
    {
        return $q->where('payment_method', $m);
    }
