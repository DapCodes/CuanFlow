...
@section('title', 'Tambah Status Tugas')
@section('page-title', 'Tambah Status Tugas')
...
<div class="max-w-2xl mx-auto">
    <form action="{{ route('admin.task-statuses.store') }}" method="POST" class="space-y-6">
        @csrf
        
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-900">Tambah Status Baru</h2>
