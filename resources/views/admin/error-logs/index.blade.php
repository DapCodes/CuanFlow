...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        ...
        <div class="flex items-center gap-3">
            <form action="{{ route('admin.security.error-logs.clear') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus semua error log secara permanen?');">
                @csrf
                <button type="submit" 
                        class="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 text-white text-sm font-semibold rounded-xl hover:bg-red-700 transition-all duration-200 shadow-sm shadow-red-200">
                    <i class="fas fa-trash-can text-xs opacity-80"></i>
