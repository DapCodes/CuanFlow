    ...
    <form action="{{ route('admin.roles.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Buat role baru dan atur permission-nya</p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <input type="text" 
                       ...
                       value="{{ old('name') }}"
                       required
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cuan-green focus:border-cuan-green @error('name') border-red-300 @enderror"
