            ...
            <form action="{{ route('products-hpp.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="step-content p-6 hidden" id="step3">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Perbarui bahan baku dan jumlah yang diperlukan untuk resep ini</p>
                    </div>
                    ...
                    <div id="recipeItemsContainer" class="space-y-4">
                        ...
                        @if($itemCount > 0)
                            ...
                            @endforeach
                        @else
                            {{-- Default empty item jika tidak ada data --}}
                            <div class="recipe-item border border-gray-200 rounded-lg p-5 bg-gray-50">
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                    <div class="md:col-span-5">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div class="step-content p-6 hidden" id="step4">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Perbarui biaya overhead seperti listrik, gas, packaging, dll</p>
                    </div>
