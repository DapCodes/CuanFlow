...
<div class="max-w-2xl mx-auto">
    <form action="{{ route('admin.units.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-900">Tambah Unit Baru</h2>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="number" name="conversion_factor" id="conversion_factor" value="{{ old('conversion_factor', 1) }}"
                           step="0.000001" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cuan-green"
                           placeholder="1">
                    <p class="mt-1 text-xs text-gray-500">Contoh: 1 kg = 1000 gram, maka faktor konversi kg = 1000</p>
                </div>
            </div>
