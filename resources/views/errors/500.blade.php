...
<head>
    ...
    <title>500 - Kesalahan Server | CuanFlow</title>
...
<body class="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-2xl px-6 sm:px-8 py-12 text-center">
        ...
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 animate-on-load animate-fade-in-up delay-200">Terjadi Kesalahan Server</h2>
        <p class="text-gray-600 text-sm sm:text-base leading-relaxed mb-10 max-w-lg mx-auto animate-on-load animate-fade-in-up delay-300">
            Ups! Sesuatu tidak berjalan semestinya di sistem kami. Tim teknis kami telah diberitahu dan sedang berusaha memperbaikinya secepat mungkin.
        </p>
        <div class="flex flex-col sm:flex-row gap-3 justify-center animate-on-load animate-fade-in-up delay-400">
            <a href="{{ route('dashboard') }}" class="btn-primary px-8 py-3.5 bg-cuan-dark text-white font-semibold rounded-lg text-base">Dashboard</a>
            <a href="mailto:support@cuanflow.com" class="px-8 py-3.5 bg-white text-gray-700 font-medium rounded-lg border-2 border-gray-200 text-base hover:bg-gray-50 transition-colors">Laporkan Masalah</a>
        </div>
