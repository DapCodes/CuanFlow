            ...
            <section class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Buat dan atur diskon baru untuk outlet Anda.
                    </p>
                </div>
                    ...
                    <div class="px-8 py-8">
                        ...
                        <div class="mt-6 p-5 bg-cuan-green/5 border border-cuan-green/20 rounded-2xl">
                            <p class="text-[10px] font-black uppercase tracking-widest text-cuan-green">
                                Preview: <span id="promoPreview" class="text-sm normal-case tracking-normal font-bold text-gray-900 ml-1">Beli 1 Gratis 1</span>
                            </p>
                        </div>
                    </div>
                </x-card-container>
    ...
    generateCodeBtn.addEventListener('click', function() {
        ...
        fetch('{{ route("discounts.generate-code") }}')
            ...
            .then(data => {
                ...
                this.disabled = false;
                this.innerHTML = '<i class="fas fa-sync-alt text-xs"></i>';
            })
            .catch(error => {
