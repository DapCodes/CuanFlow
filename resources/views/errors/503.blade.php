...
<head>
    ...
    <title>503 - Sistem Maintenance | CuanFlow</title>
...
<body class="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-2xl px-6 sm:px-8 py-12 text-center">
        ...
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 animate-on-load animate-fade-in-up delay-200">Sistem Sedang Pemeliharaan</h2>
        <p class="text-gray-600 text-sm sm:text-base leading-relaxed mb-10 max-w-lg mx-auto animate-on-load animate-fade-in-up delay-300">
            Kami sedang melakukan pemeliharaan rutin untuk meningkatkan performa layanan CuanFlow. Mohon maaf atas ketidaknyamanannya, kami akan segera kembali online.
        </p>
        <div class="flex justify-center animate-on-load animate-fade-in-up delay-400">
            <a href="{{ url('/') }}" class="btn-primary px-10 py-3.5 bg-cuan-dark text-white font-semibold rounded-lg text-base">Coba Lagi Nanti</a>
        </div>
