                        ...
                        <div class="mt-4 overflow-x-auto">
                            <div id="paymentRow" class="flex gap-3 whitespace-nowrap pb-2">
                                ...
                                <div class="inline-flex items-center justify-between min-w-[240px] p-3 bg-gray-100 rounded-lg border-2 border-gray-300 gap-1">
                                    <span class="text-sm font-bold text-gray-900">Total Penjualan</span>
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="px-4 py-3 text-center">
            ${s.status === 'completed' && ['cash', 'transfer'].includes(s.payment_method) 
              ? `<button onclick="confirmRefund('${s.id}', '${s.invoice_number}', ${s.grand_total})" class="text-red-600 hover:text-red-800 font-medium text-sm"><i class="fas fa-undo mr-1"></i>Refund</button>`
              : `<span class="text-gray-400 text-xs">-</span>`
            }
          </td>
        </tr>`).join('');
