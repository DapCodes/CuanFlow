...
<head>
    ...
    <title>402 - Pembayaran Diperlukan | CuanFlow</title>
...
<body class="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-2xl px-6 sm:px-8 py-12 text-center">
        ...
        <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 animate-on-load animate-fade-in-up delay-200">Pembayaran Diperlukan</h2>
        <p class="text-gray-600 text-sm sm:text-base leading-relaxed mb-10 max-w-lg mx-auto animate-on-load animate-fade-in-up delay-300">
            Layanan ini membutuhkan pembayaran aktif untuk dapat digunakan. Silakan periksa status langganan Anda atau selesaikan pembayaran yang tertunda.
        </p>
        <div class="flex flex-col sm:flex-row gap-3 justify-center animate-on-load animate-fade-in-up delay-400">
            <a href="{{ route('dashboard') }}" class="btn-primary px-8 py-3.5 bg-cuan-dark text-white font-semibold rounded-lg text-base">Cek Langganan</a>
            <a href="{{ url('/') }}" class="px-8 py-3.5 bg-white text-gray-700 font-medium rounded-lg border-2 border-gray-200 text-base hover:bg-gray-50 transition-colors">Kembali</a>
        </div>
