        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-lg bg-purple-100 flex items-center justify-center" id="icon-preview">
                        <i class="fas fa-folder text-purple-600 text-xl"></i>
                    </div>
                    <span class="text-sm text-gray-600" id="icon-name">fas fa-folder</span>
                </div>
            </div>
        </div>
...
document.getElementById('icon').addEventListener('input', function() {
    ...
    document.getElementById('icon-preview').innerHTML = `<i class="${iconClass} text-purple-600 text-xl"></i>`;
