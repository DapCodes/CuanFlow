...
<li class="flex items-center">
    ...
    <span class="text-gray-900 font-medium">Edit Kebijakan</span>
</li>
@endsection
                ...
                <div class="p-6 md:p-10 space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <textarea name="content" id="content" rows="12" required placeholder="Tuliskan detail prosedur atau aturan di sini..."
                            class="w-full px-5 py-4 bg-[#f9fafb] border-gray-200 rounded-2xl text-sm font-bold text-gray-900 focus:ring-4 focus:ring-gray-900/5 focus:border-gray-900 focus:bg-white transition-all placeholder:text-gray-300 resize-none">{{ old('content', $outletPolicy->content) }}</textarea>
