...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Kelola Permissions</h1>
                <p class="text-sm text-gray-500 mt-0.5 font-medium">Total {{ $totalPermissions }} hak akses sistem dalam {{ $permissionCategories->count() }} kategori</p>
            </div>
        </div>
