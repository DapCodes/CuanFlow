    ...
    public function run(): void
    {
        ...
        $productsData = [
            ...
            [
                ...
                'shelf_life_days' => 365,
                'is_stock' => true, // Inventory based
                'description' => 'Teh Pucuk harum dingin',
            ],
            [
                'code' => 'LEMINEC',
                'name' => 'Minuman Lemonade',
                'barcode' => 'LEMINEC',
                'category_slug' => 'minuman',
                'unit_abbreviation' => 'pcs',
                'selling_price' => 10000.00,
                ...
                'shelf_life_days' => 365,
                'is_stock' => true, // Inventory based
                'description' => 'Minuman Lemonade dingin',
            ],
            [
                'code' => 'CHUKA',
                'name' => 'Chuka Idako',
            ...
            [
                ...
                'reseller_price' => 10000.00,
                'min_stock' => 10,
                'shelf_life_days' => 90,
                'is_stock' => true,
                'description' => 'Keripik Tempe',
                'recipe' => [
                    'name' => 'Resell Keripik Tempe',
                    'output_quantity' => 1,
                    'estimated_time_minutes' => 1,
                    'instructions' => 'Sudah siap saji',
                    'items' => [
                        ['code' => 'RM001', 'quantity' => 25],
                        ['code' => 'RM010', 'quantity' => 0.25],
                    ],
                ],
            ],
        ];
        ...
        foreach ($targetOutletIds as $targetOutletId) {
            $rawMaterials = RawMaterial::where('outlet_id', $targetOutletId)->get()->keyBy('code');
            $createdProducts = [];

            // Cleanup existing products for this outlet to avoid duplicates
            ...
            foreach ($productsData as $productData) {
                ...
                if (isset($productData['recipe'])) {
                    ...
                    // Default HPP for trading items (45% of selling price)
                    $totalHpp = $productData['selling_price'] * 0.45;
                    $hppPerUnit = $totalHpp;
                    $outputQuantity = 1;
                    $rawMaterialCost = $totalHpp;
                    $additionalCost = 0;
                }
                ...
                if (isset($productData['recipe'])) {
                    ...
                    // Buat HPP Calculation untuk produk tanpa resep
                    HppCalculation::create([
                        'product_id' => $product->id,
                        'recipe_id' => null,
                        'raw_material_cost' => round($totalHpp, 2),
                        'additional_cost' => 0,
                        'total_hpp' => round($totalHpp, 2),
                        'hpp_per_unit' => round($hppPerUnit, 2),
                        'output_quantity' => 1,
                        'calculation_details' => json_encode([
                            'summary' => [
                                'method' => '45% of selling price',
                                'selling_price' => $productData['selling_price'],
                                'total_hpp' => round($totalHpp, 2),
                            ],
                        ]),
                        'notes' => 'HPP estimated at 45% of selling price (Trading/Non-Recipe product).',
                        'calculated_by' => null,
                        'created_at' => now(),
                        'updated_at' => now(),
                    ]);
            ...
            $discountsData = [
                ...
                [
                    'code' => 'DISC-AQUA-PROMO-'.$targetOutletId,
            ...
            echo "========================================\n";
            echo "✓ Selesai melakukan seeding untuk Outlet ID: {$targetOutletId}\n";
            echo "========================================\n\n";
        }
    }
}
