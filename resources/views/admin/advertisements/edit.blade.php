...
<li class="flex items-center gap-2">
    ...
    <span class="text-emerald-600 font-semibold tracking-wide text-sm">Edit Iklan #{{ $advertisement->id }}</span>
</li>
@endsection
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Iklan</h1>
                <p class="text-sm text-gray-500 mt-0.5 font-medium">Ubah informasi iklan dan banner promo</p>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.advertisements.update', $advertisement) }}" method="POST" enctype="multipart/form-data" class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $advertisement->title) }}" required placeholder="Ex: Promo Lebaran"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="url" name="url" id="url" value="{{ old('url', $advertisement->url) }}" placeholder="https://..."
                               class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">
                ...
                <div class="space-y-1">
                    ...
                    <textarea name="description" id="description" rows="2" placeholder="Tuliskan deskripsi ringkas..."
                              class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">{{ old('description', $advertisement->description) }}</textarea>
            ...
            <div class="space-y-4 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 items-start">
                    <div>
                        ...
                        <img src="{{ $advertisement->banner_url }}" class="w-full h-auto rounded-xl border border-gray-200 shadow-sm object-cover" alt="Banner Preview">
                    </div>
                    
                    <div class="space-y-1">
                        <label for="banner" class="text-sm font-medium text-gray-700">Ganti Gambar Banner</label>
                        ...
                        <p class="text-[11px] text-gray-500 mt-1">Kosongkan jika tidak ingin merubah gambar. Format didukung: JPG, PNG, GIF. Maks: 2MB.</p>
            ...
            <div class="space-y-4 pt-4">
                ...
                <div class="space-y-1">
                    ...
                    <textarea name="content" id="content" rows="4" placeholder="Tuliskan syarat dan ketentuan atau informasi lengkap..."
                              class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">{{ old('content', $advertisement->content) }}</textarea>
            ...
            <div class="space-y-4 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        ...
                        <input type="datetime-local" name="start_date" id="start_date" value="{{ old('start_date', $advertisement->start_date ? $advertisement->start_date->format('Y-m-d\TH:i') : '') }}"
                               class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="datetime-local" name="end_date" id="end_date" value="{{ old('end_date', $advertisement->end_date ? $advertisement->end_date->format('Y-m-d\TH:i') : '') }}"
                               class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $advertisement->is_active) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-600">
                        </div>
